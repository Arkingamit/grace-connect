      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="overflow-hidden rounded-2xl border-[#E5D5C5]/60 shadow-sm">
              <div className="relative aspect-video">
                  {/* YouTube Embed only when truly live */}
                  {youtubeVideoId && isLive ? (
                    ...
                    <div className="w-full h-full bg-[#1A202C] flex flex-col items-center justify-center p-8 text-center">
                      <div className="w-14 h-14 rounded-full bg-white/10 flex items-center justify-center mb-4">
                        <Radio className="w-7 h-7 text-white/40" />
                      </div>
                      <h3 className="text-xl font-semibold text-white mb-2">Not live right now</h3>
                      <p className="text-white/60 max-w-sm text-sm">
                        This campus is not broadcasting at the moment. Check back during service times or try another campus.
                      </p>
                    </div>
                  )}
                ...
                <CardContent className="p-6 bg-white">
                  <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                    <div className="space-y-2 flex-1">
                      <h3 className="text-lg font-semibold text-[#1A202C]">{activeStream?.title || 'Live Broadcast'}</h3>
                      <p className="text-muted-foreground text-sm">
                        {activeStream?.description || 'Join our live service'}
                      </p>
                    </div>
                    {isLive && youtubeVideoId && (
...
function LiveStreamPageLayout() {
  ...
  return (
    <div className="py-8 md:py-12">
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="overflow-hidden border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white rounded-3xl relative">
          {isLive && youtubeVideoId ? (
            ...
            <div className="aspect-video w-full bg-[#1A202C] relative flex flex-col items-center justify-center text-center p-6">
              <div className="w-14 h-14 rounded-full bg-white/10 flex items-center justify-center mb-4">
                <Radio className="w-7 h-7 text-white/40" />
              </div>
              <h3 className="text-2xl font-serif text-white mb-2">Not live right now</h3>
              <p className="text-white/60 mb-2 max-w-sm text-sm">
                Join us during service times — we&apos;ll be streaming here when we go live.
              </p>
            </div>
          )}
