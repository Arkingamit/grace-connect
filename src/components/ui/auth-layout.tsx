...
export function AuthPageShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden bg-[#FAF7F2] px-4 pt-[calc(env(safe-area-inset-top)+1.5rem)] pb-[calc(6rem+env(safe-area-inset-bottom))] sm:px-5 md:pt-28">
      <div
...
export const authSocialBtnClass =
  "flex h-[40px] w-full items-center justify-center gap-3 rounded-full border border-[#dadce0] bg-white text-sm font-medium text-[#3c4043] transition-colors hover:bg-gray-50";
