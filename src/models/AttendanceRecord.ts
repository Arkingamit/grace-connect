...
export interface IAttendanceRecord extends Document {
  ...
  method: 'geo' | 'qr_self' | 'leader_scan' | 'manual'; // how the attendance was recorded
  status?: 'present' | 'absent'; // whether they attended or were marked absent
...
const AttendanceRecordSchema = new Schema<IAttendanceRecord>(
  {
    ...
    method: { type: String, enum: ['geo', 'qr_self', 'leader_scan', 'manual'], default: 'geo' },
