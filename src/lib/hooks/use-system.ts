...
import { SystemSettings, FlipCardConfig, FlipCardItem } from '@/lib/types';

/** Fixed Highlights card shown to guests (non-logged-in users). */
export const GUEST_HIGHLIGHT_CARD: FlipCardItem = {
  id: 'guest-welcome',
  type: 'custom',
